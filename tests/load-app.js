...
function loadApp() {
  ...
  const returnApi = `
    return {
      ...
      getEntityPalette,
      setEntityPalette,
      FC19_LEGACY_PRESET_NAMES,
      _fc19ResolveLegacyPresetName,
      _fc19ArgbToCss,
      _fc19PaletteOptionHtml,
      _fc19PalettePickerHtml,
      _fc19CloseAllPalettePickers,
      _fc19TogglePalettePicker,
      _fc19PickPalette,
      _fc19PalettePickerTriggerKeydown,
      _collectExportData,
      _columnsFor,
      xlMoney,
      xlHours,
